...
- [ ] Consolidate repositories + repository interfaces (P2-12) — **remaining (large refactor)**; broad and cross-cutting, best validated running
- [ ] Decouple AI from `MedAssistDbContext`; drop the AI→EF reference (P2-13) — **remaining (large refactor)**; pairs with P2-12
