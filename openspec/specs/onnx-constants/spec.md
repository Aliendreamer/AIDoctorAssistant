# onnx-constants Specification

## Purpose
Define typed string constants for ONNX model tensor input/output names and model file names, eliminating raw string literals across embedder and reranker components.
